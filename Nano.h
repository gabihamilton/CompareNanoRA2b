...
// Mon Jul 17 14:41:54 2023 by ROOT version 6.26/06
// from TTree Events/Events
// found on file: nano_sample.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[110];   //[nGenPart]
   Float_t         GenPart_mass[110];   //[nGenPart]
   Float_t         GenPart_phi[110];   //[nGenPart]
   Float_t         GenPart_pt[110];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[110];   //[nGenPart]
   Int_t           GenPart_pdgId[110];   //[nGenPart]
   Int_t           GenPart_status[110];   //[nGenPart]
   Int_t           GenPart_statusFlags[110];   //[nGenPart]
   ...
   UChar_t         Jet_nConstituents[23];   //[nJet]
   ...
   UChar_t         Muon_mvaLowPtId[6];   //[nMuon]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCSVV2[5];   //[nSubJet]
   Float_t         SubJet_btagDeepB[5];   //[nSubJet]
   Float_t         SubJet_eta[5];   //[nSubJet]
   Float_t         SubJet_mass[5];   //[nSubJet]
   Float_t         SubJet_n2b1[5];   //[nSubJet]
   Float_t         SubJet_n3b1[5];   //[nSubJet]
   Float_t         SubJet_phi[5];   //[nSubJet]
   Float_t         SubJet_pt[5];   //[nSubJet]
   Float_t         SubJet_rawFactor[5];   //[nSubJet]
   Float_t         SubJet_tau1[5];   //[nSubJet]
   Float_t         SubJet_tau2[5];   //[nSubJet]
   Float_t         SubJet_tau3[5];   //[nSubJet]
   Float_t         SubJet_tau4[5];   //[nSubJet]
   UInt_t          nTau;
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[33];   //[nTrigObj]
   Float_t         TrigObj_eta[33];   //[nTrigObj]
   Float_t         TrigObj_phi[33];   //[nTrigObj]
   Float_t         TrigObj_l1pt[33];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[33];   //[nTrigObj]
   Float_t         TrigObj_l2pt[33];   //[nTrigObj]
   Int_t           TrigObj_id[33];   //[nTrigObj]
   Int_t           TrigObj_l1iso[33];   //[nTrigObj]
   Int_t           TrigObj_l1charge[33];   //[nTrigObj]
   Int_t           TrigObj_filterBits[33];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           SubJet_hadronFlavour[5];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[5];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[5];   //[nSubJet]
...
#ifdef Nano_cxx
Nano::Nano(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("nano_sample.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("nano_sample.root");
      }
...
Int_t Nano::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Nano::LoadTree(Long64_t entry)
{
