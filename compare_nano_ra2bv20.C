...
void compare_nano_ra2bv20(){
  ...
  for(int i = 0 ; i < 4 ; i++){
      ...
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Electrons_fCoordinates_fEta", "Electron_eta", 50, -5, 5, i));
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Electrons_fCoordinates_fPhi", "Electron_phi", 50, -5, 5, i));
      //comps.push_back(new CompareVars(ra2b_t, nano_t, "Electrons_fCoordinates_fE", "))
      
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Muons_fCoordinates_fPt", "Muon_pt",50, 5, 105, i));
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Muons_fCoordinates_fEta", "Muon_eta", 50, -5, 5, i));
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Muons_fCoordinates_fPhi", "Muon_phi", 50, -5, 5, i));
      //comps.push_back(new CompareVars(ra2b_t, nano_t, "Muons_fCoordinates_fE", "))
      
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Photons_fCoordinates_fPt", "Photon_pt",50, 5, 105, i));
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Photons_fCoordinates_fEta", "Photon_eta", 50, -5, 5, i));
      comps.push_back(new CompareVars(ra2b_t, nano_t, "Photons_fCoordinates_fPhi", "Photon_phi", 50, -5, 5, i));
      //comps.push_back(new CompareVars(ra2b_t, nano_t, "Photons_fCoordinates_fE", "))
  ...
  comps.push_back(new CompareVars(ra2b_t,nano_t,"fixedGridRhoFastjetAll","fixedGridRhoFastjetAll", 60, 0, 60));
