...
void muons(){
    ...
    for( int i = 0 ; i < 4 ; i++ ){
        ...
        e_pt_ra2b.push_back(new TH1F(temp,";muon p_T [GeV];Events",50,0,800));
        e_pt_ra2b.back()->SetLineWidth(2);
        e_pt_ra2b.back()->SetLineStyle(1);
        e_pt_ra2b.back()->SetLineColor(2);
        sprintf(temp,"muonpt_nano%i",i);
        e_pt_nano.push_back(new TH1F(temp,";muon p_T [GeV];Events",50,0,800));
    ...
    for( int i = 0 ; i < 4 ; i++ ){
        ...
        e_eta_ra2b.push_back(new TH1F(temp,";muon #eta [GeV];Events",50,-5,5));
        e_eta_ra2b.back()->SetLineWidth(2);
        e_eta_ra2b.back()->SetLineStyle(1);
        e_eta_ra2b.back()->SetLineColor(2);
        sprintf(temp,"muoneta_nano%i",i);
        e_eta_nano.push_back(new TH1F(temp,";muon #eta [GeV];Events",50,-5,5));
    ...
    for( int i = 0 ; i < 4 ; i++ ){
        ...
        e_phi_ra2b.push_back(new TH1F(temp,";muon #phi [GeV];Events",50,-5,5));
        e_phi_ra2b.back()->SetLineWidth(2);
        e_phi_ra2b.back()->SetLineStyle(1);
        e_phi_ra2b.back()->SetLineColor(2);
        sprintf(temp,"muonphi_nano%i",i);
        e_phi_nano.push_back(new TH1F(temp,";muon #phi [GeV];Events",50,-5,5));
    ...
    for( int evt = 0 ; evt < numEvents ; evt++ ){
        ...
        vector<int> ra2b_indices_e = filterLeptons(ra2b_t->Muons_, ra2b_t->Muons_fCoordinates_fPt, 10.0);
        vector<int> nano_indices_e = filterLeptons(nano_t->nMuon, nano_t->Muon_pt, 10.0);
